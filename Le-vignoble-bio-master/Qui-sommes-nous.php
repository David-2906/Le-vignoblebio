...
<?php
    ...
    <div>
        <img src="images/IMG_0985.png" alt="Qui sommes nous">
        </div>

        <h1> Notre histoire, </h1>

        <p>Le vignoble bio est tout d'abord une aventure humaine.
Composer de quatres développeurs web, nous avions également une passion et une grande ambition: faire découvrir à une clientèle amatrice de vin un produit d'exception.
