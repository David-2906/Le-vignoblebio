...
<!-- 
        ...
        <p1><h3>Le vignoble bio est tout d'abord une aventure humaine .
Composer de 4 développeurs web, nous avions également une passion et une grande ambition: faire découvrir à une clientèle amatrice de vin un produit d'exception.
                ...
                <div class="col-md-12 d-flex justify-content-center right-bck">
                    <div class="registration-right">
                        ...
                        <div class="event-list">
                            <div class="card flex-row"><img src="https://img.icons8.com/external-bearicons-glyph-bearicons/344/external-Home-valentine-love-bearicons-glyph-bearicons.png">
                                <div class="card-body">
                                    <p class="card-text">64 Boulevard Saint-Germain, 75005 Paris
                                    </p>
                                </div>
                            </div>
                            <div class="card flex-row"><img src="https://img.icons8.com/external-smashingstocks-glyph-smashing-stocks/344/external-email-accounting-smashingstocks-glyph-smashing-stocks.png"> 
                            <div class="card-body">
                            <p class="card-text">LeVignobleBio@gmail.com</p>
                            </div>
                            </div>
                            <div class="card flex-row"><img src="https://img.icons8.com/ios-filled/344/apple-phone.png">
                                <div class="card-body">
                                <p class="card-text">01 02 03 04 05</p>
                                </div>
                            </div>
                        </div>
                    </div>
